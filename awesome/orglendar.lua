...
files = {}
char_width = nil
-- text_color = theme.fg_normal or theme.fg_widget or "#FFFFFF"
text_color = theme.fg_widget or "#FFFFFF"
-- today_color = theme.fg_focus or theme.bg_widget or "#00FF00"
today_bg = text_color
today_color = theme.bg_widget or "#00FF00"
...
local function create_calendar()
   ...
   for day = 1, last_day do
      ...
      result = result .. (last_in_week and "" or " ")
